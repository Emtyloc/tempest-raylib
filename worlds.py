...
circle_world = LevelData(
    x = [510.0, 494.0, 448.0, 380.0, 300.0, 220.0, 152.0, 106.0, 90.0, 106.0, 152.0, 220.0, 300.0, 380.0, 448.0, 494.0],
    y = [400.0, 480.0, 548.0, 594.0, 610.0, 594.0, 548.0, 480.0, 400.0, 320.0, 252.0, 206.0, 190.0, 206.0, 252.0, 320.0],
    scale=1,
    y3d=80,
    y2d=0,
    y2db=0,
...
line_world = LevelData(
    x=[600.0, 560.0, 520.0, 480.0, 440.0, 400.0, 360.0, 320.0, 280.0, 240.0, 200.0, 160.0, 120.0, 80.0, 40.0, 0.0],
...
heart_world = LevelData(
    x=[360.0, 450.0, 480.0, 480.0, 450.0, 390.0, 300.0, 210.0, 150.0, 120.0, 120.0, 150.0, 240.0, 285.0, 300.0, 315.0],
    y=[220.0, 229.0, 340.0, 460.0, 550.0, 610.0, 640.0, 610.0, 550.0, 460.0, 340.0, 229.0, 220.0, 310.0, 430.0, 310.0],
    scale=1,
    y3d=165,
    y2d=0,
    y2db=0,
...
star_world = LevelData(
    x=[180.0, 100.0, 140.0, 100.0, 180.0, 220.0, 300.0, 380.0, 420.0, 500.0, 460.0, 500.0, 420.0, 380.0, 300.0, 220.0],
    y=[530.0, 500.0, 400.0, 300.0, 270.0, 180.0, 230.0, 180.0, 270.0, 300.0, 400.0, 500.0, 530.0, 620.0, 570.0, 620.0],
    scale=1,
    y3d=50,
    y2d=0,
    y2db=0,
...
broken_v_world = LevelData(
    ...
    y=[160.0, 238.0, 310.0, 394.0, 379.0, 445.0, 520.0, 565.0, 550.0, 595.0, 520.0, 460.0, 370.0, 310.0, 250.0, 190.0],
    scale=1,
    y3d=-60,
    y2d=0,
    y2db=0,
